export const companySpecificMockInterviewFeedback = (
  candidateName,
  companyName,
  role,
  experienceLevel,
  ...
  >
    ...
    >
      ...
      <tr>
        ...
        >
          <h1 style="margin: 0; font-size: 22px;">Your Mock Interview Feedback</h1>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding: 24px;">
          ...
          <p style="font-size: 15px; line-height: 1.6; margin: 0;">
            You’ve completed your mock interview for <strong>${role}</strong> at <strong>${companyName}</strong> (Experience Level: <strong>${experienceLevel}</strong>).
            Here’s a personalized breakdown of your performance and key takeaways to help you improve before the real one.
          </p>
        </td>
      </tr>
      ...
      <tr>
        ...
        >
          <p style="margin: 0;">
            © ${new Date().getFullYear()} <strong>SimJob</strong> — Mock. Learn. Excel.
          </p>
        </td>
      </tr>
    </table>
