export const skillBasedMockInterviewFeedback = (
  candidateName,
  skills,
  experienceLevel,
  difficulty,
...
<html>
  <head>
    ...
    <title>Skill-Based Mock Interview Feedback</title>
  </head>
  <body
    style="
  ...
  >
    ...
    >
      ...
      <tr>
        ...
        >
          <h1 style="margin: 0; font-size: 22px;">Your Skill-Based Mock Interview Feedback</h1>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding: 24px;">
          ...
          <p style="font-size: 15px; line-height: 1.6; margin: 0;">
            You’ve successfully completed a <strong>${difficulty}</strong> skill-based mock interview designed for 
            <strong>${experienceLevel}</strong> professionals.  
            Below is a summary of your performance across the selected skills.
          </p>
        </td>
      </tr>
      ...
      <tr>
        ...
        >
          <p style="margin: 0;">
            © ${new Date().getFullYear()} <strong>SimJob</strong> — Sharpen your skills. Ace every interview.
          </p>
        </td>
      </tr>
    </table>
